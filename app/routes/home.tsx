...
export default function Home() {
  ...
  const handleUploadComplete = async (base64Image: string) => {
    ...
    setProjects((prev) => [finalItem, ...prev])

    navigate(`/visualizer/${newId}`, {
      state: {
        initialImage: finalItem.sourceImage,
        initialRendered: finalItem.renderedImage || null,
        name
      }
    })
  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <h1>Beautiful spaces at the speef of though with Roomify</h1>
        ...
        <div className="actions">
          ...
          <Button onClick={() => {}} variant="outline" className="demo border-2 border-gray-500/20 font-bold">
            Watch demo
          </Button>
        </div>
